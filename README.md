...
> [!NOTE] 
> The work and codebase herein actually predate the creation time of this repository by over a year. On account of this, nothing will be expressly maintained; the findings and implementations contained herein are intended to serve as reference and contribution to the general body of science. Consequently, if seeking to replicate the experiment, ensure that everything be brought up to date.
...
> [!NOTE] 
> If there is an error in the Golem code preventing proper large-scale usage, or the implementation is unoptimized, please [open an issue](https://github.com/Lleyton-Ariton/neural-entropy/issues) to flag the issue. Improvements, clarifications, and observations are highly encouraged. 
